...
const CourseDetail = () => {
  ...
  return (
    <div className="px-4 md:px-35 mt-10 flex md:flex-row flex-col md:gap-15 gap-2">
      <div className="w-full md:w-1/3 h-[35vh] md:h-[85vh] bg-sidebar rounded-2xl border border-border sticky top-4 flex md:block">
        ...
        <img
          ...
          alt=""
          className="border border-border rounded-tl-2xl rounded-bl-2xl md:rounded-bl-none md:rounded-tr-2xl w-1/2 md:w-full h-full md:h-3/5 object-cover"
        />
