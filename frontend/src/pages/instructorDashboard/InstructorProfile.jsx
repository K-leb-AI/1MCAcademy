...
export default function InstructorProfile() {
  ...
  return (
    <>
      <div className="max-w-7xl mx-auto px-6 pb-16 pt-22 min-h-screen">
        {/* Header */}
        <motion.div
        ...
        >
          <div
            className="flex gap-2 text-foreground/50 items-center mb-2 cursor-pointer hover:text-foreground/40"
            onClick={() => navigate(-1)}
          >
              ...
              <div className="space-y-2">
                <label className="flex items-center gap-2 text-sm font-medium text-foreground">
                  ...
                  <span className="text-foreground/50 font-light">
                    (This is the name others on Nunya LA will see)
                  </span>
                </label>
